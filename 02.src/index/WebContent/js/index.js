	...
	case 13: // enter
		if (r == 1) {
			...
			if (list_Pos == 0) {
				...
				location.href = '../index/shebao_service/index.html?' + sb_Pos;
			} else if (list_Pos == 2) {
				$(".contentBody_0_bottom" + list_Pos).css({
					'visibility' : "hidden"
				});
				if (cx_Pos == 0) {
					location.href = '../index/iPanel_gout/train.html';
				} else if (cx_Pos == 1) {
					location.href = '../index/iPanel_gout/ship.html';
				} else if (cx_Pos == 2) {
					location.href = '../index/iPanel_gout/bus.html';
				} else if (cx_Pos == 3) {
					location.href = '../index/iPanel_gout/flight.html';
				}
			} else if (list_Pos == 3) {
				if (yy_Pos == 0) {
					location.href = '../index/iPanel_hospital/order.html';
				} else if (yy_Pos == 1) {
					$(".dinghai").show();
					list_Pos = 31;
				} else if (yy_Pos == 2) {
					location.href = '../index/iPanel_hospital/shanghai_h.html';
				}
			} else if (list_Pos == 5) {
				if (gg_Pos == 0) {
