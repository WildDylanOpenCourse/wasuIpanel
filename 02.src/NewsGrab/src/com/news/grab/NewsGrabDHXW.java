...
public class NewsGrabDHXW {
    ...
    // 存新闻到数据库的SQL语句
    private static String insertSQL = "insert into dhxw values (?,?,?,?,?,?)";
     ...
     */
    public NewsGrabDHXW(String url, String imgpath, String dbpath, int textlength) {
        this.url = url;
        this.path = imgpath;
        this.dbpath = dbpath;
    ...
    public String setNewsImgFile(Element ele) {
        ...
        File imgFile = new File(path + "\\0\\" + filename);
